<div class="form-group col-xs-12 col-md-6">
    <label>Universidad</label>
        {{Form::select('universidad_id',$universidad,null,['class'=>'form-control round-form','autofocus','required'])}}
</div>
<div class="form-group col-xs-12 col-md-6">
        <label>Carrera</label>
            {{Form::select('carrera_id',$carrera,null,['class'=>'form-control round-form','required'])}}
</div>
<div class="form-group col-xs-12 col-md-6">
        <label>Nombre</label>
            {{Form::text('nombre',null,['class'=>'form-control round-form','required'])}}
</div>
<div class="form-group col-xs-12 col-md-6">
